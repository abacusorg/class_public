...
int input_init_from_arguments(
  ...
  if (input_file[0] != '\0'){
    ...
    class_call(class_parser_read_file(input_file,&fc_input,errmsg),
               errmsg,
               errmsg);
    ...
    if (flag1 == _FALSE_){
      ...
      class_call(class_parser_init(&fc_root,
                             1,
                             fc_input.filename,
                             errmsg),
                 errmsg,errmsg);
  ...
  if (precision_file[0] != '\0')
    ...
    class_call(class_parser_read_file(precision_file,&fc_precision,errmsg),
               errmsg,
               errmsg);
...
int input_init(
  ...
  if (unknown_parameters_size > 0) {
    ...
    class_call(class_parser_init(&(fzw.fc),
