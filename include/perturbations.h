...
struct perturbs
{
  ...
  short has_source_delta_shift_over_w_Nb;  /**< do we need source for density Nbody gauge shift? */
  ...
  int index_tp_delta_shift_over_w_Nb; /**< index value for density Nbody gauge shift */
